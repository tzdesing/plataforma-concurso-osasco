...
export default function SimuladoMatematicaPage() {
  ...
  const fetchQuestions = async () => {
    try {
      // Buscar questões específicas de Matemática
      const response = await fetch('/api/questions?subject=Matemática&limit=10')
      const result = await response.json()
      
      if (result.success && result.questions.length > 0) {
        console.log('✅ Questões de Matemática carregadas:', result.questions.length)
        ...
        console.log('⚠️ Nenhuma questão de Matemática encontrada')
        setQuestions([])
      }
    } catch (error) {
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Carregando questões de Matemática...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="container mx-auto px-4 py-8">
        <Card>
          <CardContent className="text-center py-8">
            ...
            <p className="text-gray-600 mb-4">Nenhuma questão de Matemática disponível no momento.</p>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Pratique cálculos e raciocínio lógico-matemático
            </p>
          </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="text-center mb-6">
                ...
                <div className="text-gray-600">Questões de Matemática</div>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <h3 className="font-semibold text-green-800 mb-2">Conteúdo abordado:</h3>
                <ul className="text-sm text-green-700 space-y-1">
                  <li>• Operações fundamentais (adição, subtração, multiplicação, divisão)</li>
                  <li>• Frações e números decimais</li>
                  <li>• Porcentagem e regra de três</li>
                  <li>• Geometria básica (área, perímetro, volume)</li>
                  <li>• Problemas de raciocínio lógico</li>
                  <li>• Sistemas de medidas</li>
                </ul>
              </div>
            </CardContent>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 m-6">
              ...
              <ul className="text-sm text-yellow-700 space-y-1">
                ...
                <li>• Leia com atenção os enunciados dos problemas</li>
                <li>• Faça os cálculos com cuidado</li>
                <li>• Use papel para rascunho se necessário</li>
              </ul>
            </div>
          ...
          <Card>
            <CardHeader className="text-center">
              <CardTitle className="flex items-center justify-center gap-2 text-2xl">
                ...
                Simulado de Matemática Concluído!
              </CardTitle>
              <CardDescription>
                Veja seu desempenho em matemática
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              {/* Resultado Geral */}
